  ...
  useEffect(() => {
    ...
    if (
      ...
      const poll = setInterval(async () => {
        try {
          const res = await axios.get(`http://localhost:5000/api/yatriks/verify-payment?orderId=${paymentLinkId}`);
        ...
        <div className="event-details-content">
          ...
          <div className="registration-container">
            <div className="registration-child">
              ...
              ) : paymentStatusDialog === PaymentStatusType.PAID ? (
                // Thank you dialog
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '300px', padding: '2rem 1rem' }}>
              ...
              ) : paymentStatusDialog === PaymentStatusType.CANCELLED || paymentStatusDialog === PaymentStatusType.FAILED ? (
                // Error dialog
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '300px', padding: '2rem 1rem' }}>
                  <div style={{ background: '#ffebee', border: '1px solid #e53935', borderRadius: '12px', padding: '2rem 2.5rem', textAlign: 'center', boxShadow: '0 2px 8px rgba(229,57,53,0.07)' }}>
                    ...
                    <h2 style={{ color: '#b71c1c', marginBottom: '0.5rem' }}>Payment Cancelled or Failed</h2>
                    <div style={{ fontSize: '1.1rem', color: '#b71c1c', marginBottom: '1.5rem' }}>
                      Your payment was not successful. If you believe this is an error, please try again or contact support.
                    </div>
                  </div>
                </div>
              ) : (
